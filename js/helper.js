...
var HTMLcontactGeneric = '<h4 class="flex-item"><span class="red-text">%contact%</span><span class="white-text">%data%</span></h4>';
...
var HTMLworkEmployer = '<a class="red-text" href="%href%">%data%';
...
var HTMLschoolName = '<a id="schoolName" class="red-text" href="#">%data%';
var HTMLschoolDegree = ' -- %data%</a>';
var HTMLschoolDates = '<div class="date-text">%data%</div>';
var HTMLschoolLocation = '<div class="location-text">%data%</div>';
var HTMLschoolMajor = '<div><br><em>Major: %data%</em></div>';
